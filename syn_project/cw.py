...
custom_weights_learn = {
    ...
    # Cible: V_LATENTS
    'translation_position_to_v_latents': 1.0,
    'translation_color_to_v_latents': 1.0,
    'translation_position/color_to_v_latents': 1.0,

    # --- CYCLES (1-through-N) ---
    # Source: position
    'cycle_position_through_color': 1.0,
    'cycle_position_through_v_latents': 1.0,
    'cycle_position_through_color/v_latents': 1.0,

    # Source: COLOR
    'cycle_color_through_position': 1.0,
    'cycle_color_through_v_latents': 1.0,
    'cycle_color_through_position/v_latents': 1.0,

    # Source: V_LATENTS
    'cycle_v_latents_through_position': 1.0,
    'cycle_v_latents_through_color': 1.0,
    'cycle_v_latents_through_position/color': 1.0,

    # --- CONTRASTIVE (Pairs) ---
    'contrastive_position_and_color': 1.0,
    'contrastive_position_and_v_latents': 1.0,
    'contrastive_color_and_v_latents': 1.0,
}


custom_weights_4mod_step1 = {
    # --- DEMI-CYCLE (Reconstruction directe) ---
    'demi_cycle_position': 1.0,
    'demi_cycle_color': 1.0,
    'demi_cycle_v_latents': 1.0,
    ...
    'cycle_v_latents_through_position': 0.0,
    'cycle_v_latents_through_color': 0.0,
    'cycle_v_latents_through_color/position': 1.0,
}


custom_weights_4mod_step2 = {
...
# --- Source: CAT ---
  ...
  'translation_cat/color_to_v_latents': 1.0,
  'translation_cat/position_to_v_latents': 1.0,
  'translation_color/position_to_v_latents': 0.0,
  'translation_cat/color/position_to_v_latents': 1.0
  }
